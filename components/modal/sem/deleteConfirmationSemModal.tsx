...
const DeleteConfirmationSemModal = ({ visible, onClose }:Idelette) => {
          ...
          <View className='pl-4 pr-4 flex-1 justify-center items-center  backdrop-opacity-10 backdrop-invert bg-black/75'>
            <View className='w-11/12 bg-white p-6 rounded-lg shadow-lg'>
              ...
              <Text className='text-base text-gray-700 mb-6'>
                Do you want to delete  semesters? It will delete all the  exam results, and weights as well...
              </Text>
...
export default DeleteConfirmationSemModal
